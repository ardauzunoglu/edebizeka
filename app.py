...
def siirde_sair_tahmini():
    ...
    if request.method == "POST" and predict_form.validate(): 
        ...
        poet_info = {
            ...
            "Mehmet Akif Ersoy":["Milli Edebiyat", "20. yüzyılın 1. yarısı", "(1873 – 1936), 20. yüzyılda Türk-İslam milliyetçiliğinin en büyük sanatçısıdır.", "SAFAHAT (Tek kitabı olan bu eserde tüm şiirlerini toplamıştır.) Safahat, Süleymaniye Kürsüsünde, Hakkın Sesleri, Fatih Kürsüsünde, Hatıralar, Asım, Gölgeler” adlı yedi bölümden oluşmaktadır."],
