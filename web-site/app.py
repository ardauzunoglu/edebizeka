...
@app.route("/detayli-accuracy-oranlari-basvuru")
def detayli_accuracy_oranlari_basvuru():
    return render_template("detayli-accuracy-oranlari-basvuru.html")

@app.route("/veri-seti-bolgesel")
def veri_seti_bolgesel():
    return render_template("veri-seti-bolgesel.html")

@app.route("/detayli-accuracy-oranlari-bolgesel")
def detayli_accuracy_oranlari_bolgesel():
    return render_template("detayli-accuracy-oranlari-bolgesel.html")

@app.route("/iyilestirmeler-ve-gelistirmeler")
def iyilestirmeler_ve_gelistirmeler():
    return render_template("iyilestirmeler-ve-gelistirmeler.html")
